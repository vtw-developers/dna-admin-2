...
import com.vtw.dna.common.auth.jwt.JwtAuthenticationEntryPoint;
import com.vtw.dna.common.auth.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private String[] AUTH_GET_WHITELIST = {
    		...
    		"/board", // 게시판 목록조회
    		"/board/list", // 게시판 목록조회
    		"/board/find-popup-list", // 메인 팝업 게시글 목록조회
