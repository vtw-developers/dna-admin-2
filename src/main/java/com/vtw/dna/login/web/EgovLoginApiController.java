package com.vtw.dna.login.web;

import com.vtw.dna.common.jwt.EgovJwtTokenUtil;
import com.vtw.dna.common.service.ResponseCode;
import com.vtw.dna.common.service.ResultVO;
...
public class EgovLoginApiController {
	...
	public HashMap<String, Object> actionLogin(@RequestBody LoginVO loginVO, HttpServletRequest request) throws Exception {
		...
		if (loginResultVO != null && loginResultVO.getId() != null && !loginResultVO.getId().equals("")) {
			...
			resultMap.put("resultMessage", "a"/*egovMessageSource.getMessage("fail.common.login")*/);
		}
